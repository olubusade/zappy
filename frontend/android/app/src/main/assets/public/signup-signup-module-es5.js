...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSignupSignupSignupPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCoreUtilsPasswordValidatorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSignupSignupRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | transaction-pin-transaction-pin-module */
        "transaction-pin-transaction-pin-module").then(__webpack_require__.bind(null,
        /*! ./transaction-pin/transaction-pin.module */
  ...
  /***/
  function srcAppSignupSignupSignupPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSignupSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _core_utils_password_validator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./../../core/utils/password.validator */
    "./src/app/core/utils/password.validator.ts");
    /* harmony import */
    ...
    "./src/app/services/user.service.ts"); //import { RegisterServiceService } from '../../services/register-service.service'


    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(userService, alertCtrl, storageservice, fb, route, router) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 9:
                    if (!((_a = this.signUpFormCtrl.confirmpassword.errors) === null || _a === void 0 ? void 0 : _a.passwordMismatch)) {
                      _context2.next = 13;
                      break;
                    }
                  ...
                  case 13:
                    ...
                    this.registerUserData.transaction_pin = this.signUpForm.value['transaction_pin'].toString(); // this.registerUserData.mobile_no = parseInt(this.mobile_no);
                    ...
                    console.log(this.registerUserData); //Are you sure you want to save this record?
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          var data = _this2.mobile_no;

                          _this2.userService.registerNewUser(_this2.registerUserData).subscribe(function (resp) {
                                      ...
                                      return this.alertCtrl.create({
                                        ...
                                        buttons: [{
                                          ...
                                          handler: function handler() {
                                            ...
                                            _this3.userRespData.user_id = resp.data.id;
                                            _this3.userRespData.mobile_no = resp.data.mobile_no;
                                            _this3.userRespData.first_name = resp.data.first_name;
                                            _this3.userRespData.last_name = resp.data.last_name;
                                            _this3.userRespData.role_id = resp.data.role_id;
                                            _this3.userRespData.access_token = resp.data.access_token;
                                            localStorage.setItem("setting:user_id", _this3.userRespData.user_id);
                                            localStorage.setItem("setting:first_name", _this3.userRespData.first_name);
                                            localStorage.setItem("setting:last_name", _this3.userRespData.last_name);
                                            localStorage.setItem("setting:mobile_no", _this3.userRespData.mobile_no);
                                            localStorage.setItem("setting:email", _this3.userRespData.email);
                                            localStorage.setItem('setting:role_id', _this3.userRespData.role_id);
                                            localStorage.setItem('setting:access_token', _this3.userRespData.access_token);
                                            localStorage.setItem('setting:wallet_amount', _this3.userRespData.wallet_amount);
                                            localStorage.setItem('setting:points', _this3.userRespData.points);
                                            ...
                                            localStorage.setItem("setting:address", resp.data.address); //route to user-dashboard

                                            _this3.router.navigate(['/user-dashboard']);
                                          }
                                        }]
                                      });
    ...
    SignupPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/signup/signup/signup.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./signup.page.scss */
      "./src/app/signup/signup/signup.page.scss"))["default"]]
    })], SignupPage);
    /***/
  }
}]);
