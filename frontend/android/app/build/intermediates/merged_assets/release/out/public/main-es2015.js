...
const routes = [
    ...
    {
        path: 'forgotpassword',
        loadChildren: () => __webpack_require__.e(/*! import() | login-forgotpassword-forgotpassword-module */ "forgotpassword-forgotpassword-module").then(__webpack_require__.bind(null, /*! ./login/forgotpassword/forgotpassword.module */ "./src/app/login/forgotpassword/forgotpassword.module.ts")).then(m => m.ForgotpasswordPageModule)
    },
    {
        path: 'home',
    ...
    {
        path: 'logout',
        loadChildren: () => __webpack_require__.e(/*! import() | login-logout-logout-module */ "logout-logout-module").then(__webpack_require__.bind(null, /*! ./login/logout/logout.module */ "./src/app/login/logout/logout.module.ts")).then(m => m.LogoutPageModule)
    },
    {
        path: 'newlogin',
        loadChildren: () => __webpack_require__.e(/*! import() | newlogin-newlogin-module */ "newlogin-newlogin-module").then(__webpack_require__.bind(null, /*! ./newlogin/newlogin.module */ "./src/app/newlogin/newlogin.module.ts")).then(m => m.NewloginPageModule)
    },
    {
        path: 'user-dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() | user-dashboard-user-dashboard-module */ "user-dashboard-user-dashboard-module").then(__webpack_require__.bind(null, /*! ./user-dashboard/user-dashboard.module */ "./src/app/user-dashboard/user-dashboard.module.ts")).then(m => m.UserDashboardPageModule)
    },
    {
        path: 'landing-page',
        loadChildren: () => __webpack_require__.e(/*! import() | landing-page-landing-page-module */ "landing-page-landing-page-module").then(__webpack_require__.bind(null, /*! ./landing-page/landing-page.module */ "./src/app/landing-page/landing-page.module.ts")).then(m => m.LandingPagePageModule)
    },
    {
        path: 'walk-through',
        loadChildren: () => __webpack_require__.e(/*! import() | walk-through-walk-through-module */ "walk-through-walk-through-module").then(__webpack_require__.bind(null, /*! ./walk-through/walk-through.module */ "./src/app/walk-through/walk-through.module.ts")).then(m => m.WalkThroughPageModule)
    },
    {
        path: 'user-dashboard2',
        loadChildren: () => __webpack_require__.e(/*! import() | user-dashboard2-user-dashboard2-module */ "user-dashboard2-user-dashboard2-module").then(__webpack_require__.bind(null, /*! ./user-dashboard2/user-dashboard2.module */ "./src/app/user-dashboard2/user-dashboard2.module.ts")).then(m => m.UserDashboard2PageModule)
    },
    {
        path: 'dashboard',
    ...
    {
        path: 'otp/:m',
        loadChildren: () => Promise.all(/*! import() | otp-otp-module */[__webpack_require__.e("common"), __webpack_require__.e("otp-otp-module")]).then(__webpack_require__.bind(null, /*! ./otp/otp.module */ "./src/app/otp/otp.module.ts")).then(m => m.OtpPageModule)
    },
    {
        path: 'signup/:m',
        loadChildren: () => Promise.all(/*! import() | signup-signup-module */[__webpack_require__.e("default~add-money-add-money-module~login-login-module~profile-profile-module~signup-signup-module"), __webpack_require__.e("common"), __webpack_require__.e("signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "./src/app/signup/signup.module.ts")).then(m => m.SignupPageModule)
    },
    {
        path: 'transaction-pin',
        loadChildren: () => __webpack_require__.e(/*! import() | signup-transaction-pin-transaction-pin-module */ "transaction-pin-transaction-pin-module").then(__webpack_require__.bind(null, /*! ./signup/transaction-pin/transaction-pin.module */ "./src/app/signup/transaction-pin/transaction-pin.module.ts")).then(m => m.TransactionPinPageModule)
    },
    {
        path: 'menu/referral',
...
let AppComponent = class AppComponent {
    ...
    tokenExpired(token) {
        ...
        const decode = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_7__["default"])(token);
...
AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./app.component.scss */ "./src/app/app.component.scss")).default, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ../assets/css/main.scss */ "./src/assets/css/main.scss")).default]
    })
], AppComponent);
...
/* harmony import */ var _core_utils_GlobalErrorHandler__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./core/utils/GlobalErrorHandler */ "./src/app/core/utils/GlobalErrorHandler.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _app_core_utils_TokenInterceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../app/core/utils/TokenInterceptor */ "./src/app/core/utils/TokenInterceptor.ts");
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic/storage-angular */ "./node_modules/@ionic/storage-angular/__ivy_ngcc__/fesm2015/ionic-storage-angular.js");
...
module.exports = __webpack_require__(/*! C:\Users\Lenovo\documents\vsc_local_dev\native-mobile-app\zappy\frontend\src\main.ts */"./src/main.ts");
